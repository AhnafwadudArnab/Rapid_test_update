...
class ExpandableTextState extends State<ExpandableText> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: lastHalf.isEmpty?SmallText(color:AppColor.paraColor,size:Dimensions.font17,text: firstHalf):Column(
        children: [
          SmallText(height:1.8,color:AppColor.paraColor,size:Dimensions.font15,text: HiddenText?("$firstHalf. . ."):(firstHalf+lastHalf)),
          InkWell(
            onTap: (){
              setState(() {
